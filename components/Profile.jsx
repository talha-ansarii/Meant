  ...
  return (
    ...
    
    {
      ...
      <div className='text-black bg-[#F7879A]/[18%] w-[98%] h-[98%] m-auto rounded-[10px] p-6'>
        <h3 className="text-[20px] playfair font-[700] leading-[26.66px] mb-[50px]">My Addresses</h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {addresses.map((address, i) => (
            <div key={i} className="bg-white rounded-lg shadow-lg p-4">
              <h4 className="text-[13px] playfair font-[700] leading-[17.66px]">{address.address.firstName} {address.address.lastName}</h4>
              <p className='text-[12px] playfair font-[500] leading-[18.66px]'>{address.address.address}
              ...
              <p className="text-[13px] playfair font-[700] leading-[17.66px]">{address.address.phone}</p>
              <div className="flex justify-end gap-4 mt-2">
                ...
                onClick={() => {
                 ...
                 className="text-[8px] playfair font-[700] leading-[10.66px]">Edit</button>
