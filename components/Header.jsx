  ...
  return (
    <div
      className={`w-full m-auto top-[30px] duration-200 left-[50%] translate-x-[-50%] px-[20px] absolute lg:fixed  md:fixed z-50 transition-transform ${
        scrollDirection === "down" ? "translate-y-0 md:-translate-y-[80px] lg:-translate-y-[80px] " : " translate-y-0 "
      }`}
    >
          ...
          <div className="flex w-full ">
            ...
            <div>
              <AnimatePresence>
                {isOpen && (
                  <motion.div
                    className="fixed top-0 playfair md:hidden bg-black  bottom-0  h-[calc(100vh-86px)] lg:hidden inset-0 z-[200] justify-evenly pb-[80px] items-start pl-6 text-font-blue inter font-[700] text-[20px] flex flex-col gap-[32px]"
                    initial="hidden"
                    animate="visible"
                    exit="hidden"
