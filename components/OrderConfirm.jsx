...
const OrderConfirm = () => {
  ...
  const handleGetOrder = async (razorpayPaymentId) => {
    try {
      const fetchedOrder = await getOrderByRazorpayPaymentId(razorpayPaymentId);
...
// {
//   _id: '66b420d65e0683406c567258',
//     userId: 'user_2kFaycfzO0sr2EVnNhZY6zQTPTx',
//     products: [ { productId: '60', quantity: 1, _id: '66b420d65e0683406c567259' } ],
//     amount: 1999,
//     razorpay_order_id: 'order_OiE2uv2LE4NCfz',
//     razorpay_payment_id: 'pay_OiE32g25tu0Ojr',
//     razorpay_signature: 
//       'ca190bed69ea15c5e42710c6bb4beb4a942eb276e2075b8e026c6e49633d32e7',
//     payment_confirmation: true,
//     tracking_status: 'pending',
//     address: false,
//     createdAt: '2024-08-08T01:35:18.559Z',
//     updatedAt: '2024-08-08T01:35:18.559Z',
//     __v: 0
//   }
  ...
  return (
    <div className='bg-white   w-full mb-12'>
        ...
        <div className='text-black p-4 mb-4'>
            <div className='playfair font-[700] text-[20px] leading-[26px] mb-6 text-center'>Order Id - {order?.razorpay_order_id}</div>
            <div className='flex  place-items-center flex-col gap-4 md:w-[80%] m-auto md:grid md:grid-cols-2'>
                ...
                <div className='w-[150px]'>
                    ...
                    <div className='font-merriweather font-[400] text-[12px] leading-[15px] text-[#827777]'>Razorpay</div>
                </div>
                <div className='w-[150px]'>
                    <div className='playfair font-[700] text-[16px] leading-[21px] text-left'>EMAIL</div>
                ...
                <div className='w-[150px]'>
                   ...
                   <div className='font-merriweather font-[400] text-[12px] leading-[15px] text-[#827777]'>{formatDate(order?.createdAt)}</div>
                </div>
                <div className='w-[150px]'>
                ...
                <div className='w-[150px]'>
                    ...
                    <div className='font-merriweather font-[400] text-[12px] leading-[15px] text-[#827777]'>{order?.address}
</div>
                </div>
        ...
        {/* ORDER SUMMARY */}
        <div>
        <div className='playfair font-[700] text-[20px] leading-[26px] mb-6 text-center text-black my-6'>Payment Id - {order?.razorpay_payment_id}</div>
        {products.map((item) => (
            <div
              key={item.id}
          ...
          <div className='w-full flex justify-between md:justify-center md:gap-[100px]'>
            ...
            <div className='font-poppins font-[600] text-[10px]  text-[#827777]'>Rs.{total}</div>
          </div>
          <div className='w-full flex justify-between md:justify-center md:gap-[100px]'>
            <div className='font-poppins font-[600] text-[10px]'>Delivery:</div>
            <div className='font-poppins font-[600] text-[10px] text-[#827777]'>Rs.0.0</div>
          </div>
          ...
          <div className='w-full flex justify-between md:justify-center md:gap-[79px]'>
            ...
            <div className='font-poppins font-[600] text-[12px] text-black'>Rs.{total}</div>
          </div>
