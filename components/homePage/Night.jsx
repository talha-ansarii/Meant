  ...
  return (
    <div>
      <div className="w-full h-[600px] bg-black relative overflow-hidden">
        <div className="bg-black md:mt-[0px] lg:mt-[0px] md:w-[90%] w-[80%] h-[100vh] md:flex-row lg:flex-row flex-col overflow-hidden m-auto flex  ">
          <Meteors number={20} />
          ...
          width={500}
          height={500}
          className="z-[1000] relative  object-cover w-[100%] h-[100%] md:w-[50%] lg:w-[50%] md:h-[100vh] lg:h-[100vh] "
          />

          </div>


          <div className="w-[90%] md:flex lg:flex md:w-[50%] lg:w-[50%] text-white z-20 flex flex-col lg:gap-10 gap-4 lg:px-16 md:px-16 h-[850px] md:pt-[200px] lg:pt-[200px]">
